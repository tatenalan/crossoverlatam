...
@section('main')
  ...
  <section class="clinicas">
      ...
      <div class="clinica">
        ...
        <div class="texto">
          <h3 class="celeste">Clínica 1 Líderes Inteligentes</h3>
      ...
      <div class="clinica">
        ...
        <div class="texto">
          <h3 class="celeste">Clínica 2 - Liderazgo Equipos Despistados</h3>
      ...
      <div class="clinica">
        ...
        <div class="texto">
          <h3 class="celeste">Clínica 3 - Liderazgo Faro en la Tormenta</h3>
      ...
      <div class="clinica">
        ...
        <div class="texto">
          <h3 class="celeste">Clínica 4 - Liderazgo Equipos en Proyecto</h3>
